...
Cada peça Amaé é desenvolvida com processos responsáveis, materiais naturais e acabamentos pensados para durar. Não aceleramos o tempo. Nós o respeitamos.`,
    ...
    },
    {
      ...
      content: 'Trabalhamos com pigmentos naturais: hibisco, café, cúrcuma, cebola, feijão preto e carvão. Cada cor tem uma origem, uma história. O tingimento natural é um ritual de paciência, onde a cor nasce do tempo e da temperatura, do encontro entre planta e fibra.',
      image: process2,
    },
    {
  ...
  return (
    <div className="min-h-screen pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20">
      {/* Hero */}
      <div className="container mx-auto px-4 sm:px-6 md:px-4 max-w-4xl mb-12 sm:mb-16 md:mb-20 lg:mb-32">
        <ScrollReveal>
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-playfair text-foreground mb-4 sm:mb-6 md:mb-10 leading-tight px-2">
              Manifesto
            </h1>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground italic max-w-2xl mx-auto font-playfair font-light px-4">
      ...
      <div className="space-y-16 sm:space-y-20 md:space-y-32 lg:space-y-40">
        {manifestoSections.map((section, index) => (
          <section
            key={index}
            className="container mx-auto px-4 sm:px-6 md:px-4 max-w-6xl"
          >
            <div
            ...
            >
              ...
              <ScrollReveal delay={150}>
                <div className={`space-y-4 sm:space-y-5 md:space-y-8 px-2 w-full ${
                  index % 2 === 1 ? 'md:order-1' : 'md:order-2'
                }`}>
                  <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-playfair text-foreground leading-tight">
                    {section.title}
                  </h2>
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground leading-relaxed font-light whitespace-pre-line">
                    {section.content}
                  </p>
                </div>
              </ScrollReveal>
      ...
      {/* Final Quote */}
      <div className="container mx-auto px-4 sm:px-6 max-w-3xl mt-20 sm:mt-32 md:mt-40">
        <ScrollReveal>
          <div className="text-center py-12 sm:py-16 md:py-20 border-t border-border/50">
            <blockquote className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-playfair text-foreground italic font-light leading-relaxed px-4">
